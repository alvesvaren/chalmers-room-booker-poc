...
export function CapacityRangeSlider({
  ...
  return (
    <div className={disabled ? "pointer-events-none opacity-50" : ""}>
      ...
      <div className="relative mt-4 h-12" role="group" aria-labelledby={labelId}>
        <div
        ...
        />
        <div
          className="from-te-accent/25 via-te-accent/45 to-te-accent/25 pointer-events-none absolute top-1/2 h-2.5 -translate-y-1/2 rounded-full bg-linear-to-r shadow-[inset_0_1px_0_rgba(255,255,255,0.35)]"
          style={{
            left: `${loPct}%`,
      ...
      <div
        className="text-te-muted/90 mt-2 flex justify-between font-mono text-[0.65rem] font-medium tracking-wider uppercase"
        aria-hidden
      >
        <span>{minBound}</span>
        <span>{maxBound}</span>
